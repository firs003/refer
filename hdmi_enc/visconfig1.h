...
#define CLIENT_DATATCPPORT		8088	//编码板用于发送TCP数据时，采用的默认端口，实际端口可根据相关参数配置调整
#define SERVER_CONNECTUDPPORT	4040	//PC端(服务器)用于接收点播设备发出的UDP数据，点播服务器时使用
...
enum VIDEO_TYPE{
	...
	VIDEO_TYPE_CAPTURE_YPbPr50p,	//采集Ypbpr信号 720P@50
	VIDEO_TYPE_CAPTURE_YPbPr60p,	//采集Ypbpr信号 720P@60
